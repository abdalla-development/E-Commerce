...
Future editSelectedPaymentCard({required BuildContext context, required int index}){
  return showDialog(
    context: context,
    builder: (context) => Obx(
          ()=> SizedBox(
        ...
        //             hintText: paymentController.cardTitle.value,
        ...
        //         TextField(
        //           decoration: kTextFieldDecoration.copyWith(
        //             hintText: paymentController.cardHolderName.value,
        ...
        //           decoration: kTextFieldDecoration.copyWith(
        //             hintText: paymentController.cardNumber.value,
        ...
        //                     hintText: paymentController.cardMonthExpiration.value.toString(),
        ...
        //                   decoration:  InputDecoration(
        //                     contentPadding: const EdgeInsets.fromLTRB(2,2,2,2),
        //                     hintText: paymentController.cardYearExpiration.value.toString(),
        ...
        //           paymentController.updateCurrentCard();
        //           Navigator.pop(context);
        //         }
        //       },
